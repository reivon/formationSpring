...
public class Garage {
	...
	public void execute() {
		...
		Voiture voiture = parkings.get(0)
								  .getVoitures()
								  .get(1);
		System.out.println(
				"== On vend une voiture (" + voiture.getNom() + "," + voiture.getEssence() + ") sur le parking " + parkings.get(0)
																														   .getNom());
		parkings.get(0)
				.vendreVoiture(voiture.getNom(), voiture.getEssence());
